...
/* 400px of grid for one or two voucher lines leaves most of a phone screen
   empty above the Save button. Let it size to its rows there, capped so a long
   voucher still scrolls rather than pushing the actions off-screen. */
