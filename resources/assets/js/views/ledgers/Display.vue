        ...
        <div class="row" style="float: right">
          <div class="col-sm-12" style="width: 500px">
            ...
            <p class="row">
              ...
              <span class="ml-60">
                {{ masterData.type === 'Dr' && masterData.opening_balance ? ' ₹ ' + parseFloat(masterData.opening_balance).toFixed(2) + ' ' + masterData.type : ' ₹ 0.00'}}
              </span>
              <span class="ml-60">
                {{ masterData.type === 'Cr' && masterData.opening_balance ? ' ₹ ' + parseFloat(masterData.opening_balance).toFixed(2) + ' ' + masterData.type : ' ₹ 0.00'}}
              </span>
            </p>
            <hr/>
            <p class="row">
              ...
              <span class="ml-60">
                {{ currentTotalDebit ? ' ₹ ' + parseFloat(currentTotalDebit).toFixed(2) + ' Dr' : ' ₹ 0.00'}}
              </span>
              <span class="ml-60">
                {{ currentTotalCredit ? ' ₹ ' + parseFloat(currentTotalCredit).toFixed(2) + ' Cr' : ' ₹ 0.00'}}
              </span>
            </p>
            <hr/>
            <h6 class="row">
              ...
              <span class="ml-60">
                {{ ledgerData.type === 'Dr' && ledgerData ? ' ₹ ' + parseFloat(ledgerData.balance).toFixed(2) + ' Dr': ' ₹ 0.00'}}
              </span>
              <span class="ml-60">
                {{ ledgerData.type === 'Cr' && ledgerData ? ' ₹ ' + parseFloat(ledgerData.balance).toFixed(2) + ' Cr': ' ₹ 0.00'}}
              </span>
            </h6>
          </div>
        </div>
