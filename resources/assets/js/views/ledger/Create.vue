<template>
  <div class="main-content item-create">
    <div class="page-header">
      <h3 class="page-title">{{ isEdit ? $t('ledgers.edit_bill') : $t('ledgers.new_bill') }}</h3>
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item"><a href="#"> {{ isEdit ? $t('ledgers.edit_bill') : $t('ledgers.new_bill') }}</a></li>
      </ol>
    </div>
    <div class="row">
      <div class="col-sm-6">
          ...
          <form action="" @submit.prevent="submitItem">
            <div class="card-body">
              <div class="form-group">
                <label class="control-label">{{ $t('ledgers.name') }}</label><span class="text-danger"> *</span>
                <base-input
              ...
              <!-- <div class="form-group">
                <label>{{ $t('ledgers.price') }}</label><span class="text-danger"> *</span>
              ...
              <div class="form-group">
                <label>{{ $t('ledgers.bill_ty') }}</label><span class="text-danger"> *</span>
                <base-input
              ...
              <div class="form-group">
                <label for="description">{{ $t('ledgers.description') }}</label>
                <base-text-area
...
export default {
  ...
  methods: {
    ...
    async loadEditData () {
      ...
      this.formData.unit = this.units.find(_unit => response.data.ledger.unit === _unit.name)
      this.fractional_price = response.data.ledger.price
    },
    async submitItem () {
