export const estimatesDraft = (state) => state.estimatesDraft
export const estimatesSent = (state) => state.estimatesSent
...
export const totalEstimatesDraft = (state) => state.totalEstimatesDraft
export const totalEstimatesSent = (state) => state.totalEstimatesSent
